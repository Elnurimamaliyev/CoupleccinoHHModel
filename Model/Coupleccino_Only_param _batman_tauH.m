...
c1_factor = 80; % Soma Capacitance
c2_factor = 8;  % Gap Junction Capacitance
c3_factor = 18;  % Spike Initation Zone Capacitance

% calling Rz cell model
gGCoupFactor_vals = 18.74;
