...
for Gi = 12
    ...
    set(gca, 'XTick', 0:0.2:199000/10000);
    ylim([-105, 45]);
    set(gca, 'YTick', -100:20:40);
    xlabel('time [s]');
    ylabel('potential [mV]');
    % title('Vm Presynaptic Soma (R)')
    txt_res_real_post = "Rm: " + num2str(result.Vm_Post(Gi));
    text(0.6, 25,  txt_res_real_post, 'Color', 'm', 'FontSize', 10);
    txt_hyper_real_post = "HA: " + num2str(result.amplitude_Post(Gi));
    text(0.6, 5,  txt_hyper_real_post, 'Color', 'm', 'FontSize', 10);
    ...
    txt_res_real_pre = "Rm: " + num2str(result.Vm_Post(Gi));
    text(0.6, 25,  txt_res_real_pre, 'Color', 'm', 'FontSize', 10);
    txt_hyper_real_pre = "HA: " + num2str(result.amplitude_Post(Gi));
    text(0.6, 5,  txt_hyper_real_pre, 'Color', 'm', 'FontSize', 10);
...
for Gi =8
    ...
    % txt_isi_pre = "ISI: " + num2str(result.inter_spike_interval_Pre(Gi));
    % text(0.5,5,  txt_isi_pre, color=c1, fontsize=10);
